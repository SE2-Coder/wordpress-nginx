...
LABEL maintainer="se2code"
LABEL description="WordPress PHP-FPM optimizado con WP-CLI y MySQL Client"

# ─── 1. Dependencias del sistema ───
# Añadimos 'default-mysql-client' para que 'wp db export' funcione nativamente
...
# Configuramos GD con soporte para formatos modernos (sin AVIF para compatibilidad)
...
# ─── 5. Cron para WP-Cron (Alternativa al pseudo-cron de WP) ───
